...
发送和接收所用的都是硬件编解码的方式，接收方的地址必须是固定且相同的，不同的芯片可以通过地址引脚对设备地址编码

![](assets/RF射频/file-20260205174245571.png)

以HS2264这个芯片为例，其有8个地址引脚，4个数据引脚，
...
上面我们说过“0”码和“1”码，在这个基础上如果地址引脚接高电平，由图可知在协议上就会发送一个二进制的“11”低电平发送“00”  悬空发送“01”

以下图数据为例
![](assets/RF射频/81423eec9a84cb711ca60592cce216b5.jpg)

其中315是射频频率，后满的数字是十进制获取到的数据
...
我们可以看懂它的前十六位都是01代表都是悬空的，而实际上它确实什么都没有接

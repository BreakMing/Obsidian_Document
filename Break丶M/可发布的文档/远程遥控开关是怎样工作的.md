...
它不需要编程只需要给好电源，按下遥控器按钮后接收端的对应引脚就会输出高电平，那有了这个电平信号的变化，我们就可以用一个单片机来检测这个信号，就可以做任何想做的事情了，比如控制灯的亮灭，控制舵机的转动等简单或需要一定操作逻辑的事情。

要知道他们是如何通信的，我们要先搞懂他们是如何发送信号的。这就引出了一个概念叫调制方技术。
